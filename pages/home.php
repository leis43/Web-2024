        ...
        <div class="user-actions">
            <div class="user-action-posts">
                <div class="user-actions__post">
                    <img class="user-actions-post__background" src="./static/images/images__home/SST.jpg" alt="img">
                ...
                <div class="user-actions__post">
                    <img class="user-actions-post__background" src="./static/images/images__home/SSU.png" alt="img">
                    <div class="user-actions-post__description">
                ...
                <div class="user-actions__post">
                    <img class="user-actions-post__background" src="./static/images/images__home/WF.png" alt="img">
                    <div class="user-actions-post__description">
                ...
                <div class="user-actions__post">
                    <img class="user-actions-post__background" src="./static/images/images__home/TTM.png" alt="img">
                    <div class="user-actions-post__description">
                ...
                <div class="user-actions__post">
                    <img class="user-actions-post__background" src="./static/images/images__home/AE.png" alt="img">
                    <div class="user-actions-post__description">
                ...
                <div class="user-actions__post">
                    <img class="user-actions-post__background" src="./static/images/images__home/TIA.png" alt="img">
                    <div class="user-actions-post__description">
